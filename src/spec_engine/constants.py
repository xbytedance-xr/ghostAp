...
This module provides a shared text layer for the spec_engine package,
decoupling it from the card/styles presentation layer.  The card layer
may import from here if needed, but spec_engine modules must NOT import
from card.styles directly.
"""

from __future__ import annotations

# Keys used by spec_engine modules (perspective_worker, cycle_budget,
# review_parsing, review).  Values are the single source of truth for
# engine-layer text and may be overridden in card/styles.py for
# renderer-specific formatting if needed.
