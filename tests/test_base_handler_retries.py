...
class TestBaseHandlerRetries:
    ...
    def test_send_message_passes_max_retries(self, handler):
        ...
        handler.im_client.send_message.return_value = MagicMock(success=lambda: True, data=MagicMock(message_id="msg_123"))
    ...
    def test_reply_message_passes_max_retries(self, handler):
        ...
        handler.im_client.reply_message.return_value = MagicMock(success=lambda: True, data=MagicMock(message_id="msg_456"))
    ...
    def test_reply_message_with_id_passes_max_retries(self, handler):
        # Mock im_client.reply_message
        handler.im_client.reply_message = MagicMock()
        handler.im_client.reply_message.return_value = MagicMock(success=lambda: True, data=MagicMock(message_id="msg_789"))
