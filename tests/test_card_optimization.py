...
class TestCardOptimization:
    ...
    def test_mobile_layout_optimization(self):
        """Verify engine status line uses dot separator."""
    ...
    def test_history_theme_color(self):
        """Verify history list uses turquoise theme for Coco."""
...
# ---------------------------------------------------------------------------
# Merged from test_card_truncation.py
# ---------------------------------------------------------------------------
...
class TestCardTruncation:
    def test_truncation_message_format(self):
        ...
        assert "\U0001f50d 完整日志请查看服务器本地文件" in result_content
